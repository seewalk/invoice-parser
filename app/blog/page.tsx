 ...
 * Blog Landing Page
 * 
 * Optimized with modular components:
 * - FeaturedArticles: Top 3 featured articles in highlighted grid
 * - BlogSidebar: Category filter, popular topics, CTA
 * - BlogCard: Universal card component for regular articles
 * 
 * Performance optimizations:
 * - React.memo on all child components
 * - Priority loading for first featured article (LCP)
