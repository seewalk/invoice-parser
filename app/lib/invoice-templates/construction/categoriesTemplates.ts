  ...
  templates: [
    {
      ...
      description: 'Professional invoice for commercial cleaning contracts with service period tracking, frequency documentation, and SLA references for office and commercial properties',
      tier: 'premium',
      searchVolume: 260,
      cpc: 4.11,
      difficulty: 68,
