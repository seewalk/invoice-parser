...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://elektroluma.co.uk/invoice-templates/industry',
  },
};
...
export default function IndustriesPage() {
  ...
  const collectionPageSchema = {
    ...
    description: 'Free invoice templates organized by industry. Find specialized templates for your business sector with industry-specific fields and compliance requirements.',
      ...
      <section className="pt-24 sm:pt-28 pb-12 px-4 sm:px-6 lg:px-8 border-b border-slate-200 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Stats */}
            <div className="hidden md:flex items-center justify-center gap-2 text-sm text-slate-600 mb-8 flex-wrap">
