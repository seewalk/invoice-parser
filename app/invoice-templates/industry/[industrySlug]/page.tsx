...
export async function generateMetadata({
    ...
    return {
        title: `${industry.name} Invoice Templates (${templateCount}) | Free Downloads`,
        description: `${industry.description}. Generate or Download. Word, Excel, PDF formats available.`,
        ...
        openGraph: {
            ...
            type: 'website',
            url: `https://elektroluma.co.uk/invoice-templates/industry/${industrySlug}`,
        },
        twitter: {
        ...
        alternates: {
            canonical: `https://elektroluma.co.uk/invoice-templates/industry/${industrySlug}`,
        },
    };
}
