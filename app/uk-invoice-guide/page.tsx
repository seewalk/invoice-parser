    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mb-16" id="business-identifiers">
          ...
          {/* VAT System */}
          <div className="mb-16" id="vat-system">
            <div className="flex items-center gap-3 mb-6">
          ...
          {/* CIS System */}
          <div className="mb-16" id="cis-system">
            <div className="flex items-center gap-3 mb-6">
          ...
          {/* Detailed Guides Section - NEW */}
          <div className="mb-16 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200">
            <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-slate-600 mb-8">
              Explore our comprehensive guides for detailed information, examples, and step-by-step instructions on UK invoice compliance.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link
                ...
                className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-6 border border-blue-200 hover:border-blue-400"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors">
                      VAT-Compliant Invoices: Complete Guide
                    </h3>
                    <p className="text-slate-600 text-sm mb-3">
                      Master all 4 UK VAT rates, reverse charge VAT, HMRC requirements, and Making Tax Digital compliance with real-world examples.
                    </p>
                    ...
                    <div className="mt-3 flex items-center gap-2 text-blue-600 font-semibold group-hover:gap-3 transition-all">
                      Read Full Guide
              ...
              <Link
                ...
                className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all p-6 border border-orange-200 hover:border-orange-400"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors">
                      CIS Deduction Guide: Complete Breakdown
                    </h3>
                    <p className="text-slate-600 text-sm mb-3">
                      Understand all 3 CIS rates, step-by-step calculations with VAT interaction, invoice requirements, and how to reclaim deductions.
                    </p>
                    <div className="flex items-center gap-4 text-xs text-slate-500">
                      <span className="flex items-center gap-1">
                        <Clock className="w-3 h-3" />
          ...
          {/* How to Use */}
          <div className="mb-16" id="how-to-create">
