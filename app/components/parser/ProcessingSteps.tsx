 ...
 * 
 * Displays the invoice processing steps with animations
 * Shows current progress through upload → OCR → parsing → complete
 * 
 * Features:
 * - Animated step transitions
 * - Visual feedback for active/complete/pending states
