/**
 * ============================================================================
 * OG IMAGE FOR VAT COMPLIANT EXAMPLES PAGE
 * ============================================================================
 * 
 * OG image for VAT invoice examples and templates page.
 */
...
export const alt = 'VAT Compliant Invoice Examples - UK Templates';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            VAT Compliant Invoice Examples
          </div>
          ...
          >
            Professional templates following HMRC requirements
          </div>
        </div>
